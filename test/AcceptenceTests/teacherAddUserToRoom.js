...
exports.group = {
    testTeacherAddUserSuccess: async function (test) {
        try {
    ...
    testTeacherAddUserSuccess2: async function (test) {
        try {
            await sl.users.register("elibin", "1234", "Eli", "Bin", "Male", "elib@gmail.com", false);
            await sleep(1000);
            await sl.users.register("sivanm", "1234567", "Sivan", "Mednik", "Female", "sivanm@gmail.com", false);
    ...
    testTeacherAddUserNoSuccess: async function (test) {
        try {
            await sl.users.register("elibin", "1234", "Eli", "Bin", "Male", "elib@gmail.com", false);
            await sleep(1000);
            await sl.users.register("sivanm", "1234567", "Sivan", "Mednik", "Female", "sivanm@gmail.com", false);
    ...
    testTeacherAddUserNoSuccess2: async function (test) {
        try {
            await sl.users.register("elibin", "1234", "Eli", "Bin", "Male", "elib@gmail.com", false);
            await sleep(1000);
            await sl.users.register("sivanm", "1234567", "Sivan", "Mednik", "Female", "sivanm@gmail.com", false);
